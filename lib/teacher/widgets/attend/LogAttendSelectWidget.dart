...
class LogAttendSelectWidget extends StatelessWidget {
  final String name;
  final int studentID;
  ...
  const LogAttendSelectWidget({Key? key, required this.name, required this.studentID}) : super(key: key);
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
              context,
              PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) => LogAttendScreen(
                  name: name,
                  studentID: studentID,
                ),
