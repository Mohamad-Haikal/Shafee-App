...
class StudentAttendListSelectWidget extends StatelessWidget {
  final String name;
  final int studentID;
  ...
  const StudentAttendListSelectWidget({Key? key, required this.name, required this.studentID}) : super(key: key);
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
              context,
              PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) => AddReadScreen(
                  readingType: 2,
                  studentID: studentID,
                ),
