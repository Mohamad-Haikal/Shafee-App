...
class LogReadSelectScreen extends StatefulWidget {
  const LogReadSelectScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<LogReadSelectScreen> createState() => _LogReadSelectScreenState();
}

class _LogReadSelectScreenState extends State<LogReadSelectScreen> {
  int readingType = 2;
  int yesOrNoGroup = 1;
