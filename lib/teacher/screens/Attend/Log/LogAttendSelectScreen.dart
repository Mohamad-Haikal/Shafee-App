...
import 'package:shafee_app/teacher/widgets/attend/LogAttendSelectWidget.dart';

class LogAttendSelectScreen extends StatefulWidget {
  const LogAttendSelectScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<LogAttendSelectScreen> createState() => _LogAttendSelectScreenState();
}

class _LogAttendSelectScreenState extends State<LogAttendSelectScreen> {
  int readingType = 2;
  int yesOrNoGroup = 1;
